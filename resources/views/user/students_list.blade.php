			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div style="margin-bottom: 30px;">
						<a href="/admin/new/student" data-toggle="modal" class="btn btn-info btn-add">Thêm sinh viên</a>
					</div>
					@endif
						...
						<tbody>
							...
							<tr>
								...
								<td class="col-sm-2 text-center">
									<a href="/admin/student/{{$value->id}}" type="button" class="btn btn-warning btn-edit" >
