	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="box-header">
				<h3 class="box-title">Tài khoản trợ lý phòng đào tạo</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				@csrf
				<div class="form-group">
					...
					<label for="" style="margin-top: 10px;">Mã trợ lý phòng đào tạo</label>
					...
					<label for="" style="margin-top: 10px;">Ảnh trợ lý phòng đào tạo</label>
					...
					<a href="/admin/administrator" class="btn btn-danger">Hủy bỏ</a>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$('.btn-save').click(function(){
		...
		form_data.append("position", 'Administrators');
