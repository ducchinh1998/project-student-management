			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div style="margin-bottom: 30px;">
						<a href="/admin/new/lecturer" data-toggle="modal" class="btn btn-info btn-add">Thêm giảng viên</a>
					</div>
						...
						<tbody>
							...
							<tr>
								...
								<td class="col-sm-2 text-center">
									<a href="/admin/lecturer/{{$value->id}}" type="button" class="btn btn-warning btn-edit" >
			...
			$.ajax({
				...
				success: function(response){
					if (response.is === 'success') {
						...
						setTimeout(function() {
							window.location.href = "/admin/lecturer/";
						}, 1000);
					}
