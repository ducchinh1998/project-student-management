...
<div class="container box pad">
		...
		<div class="col-xs-12">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<label for="" style="margin-top: 20px;">Mã sinh viên</label>
						...
						<label for="" style="margin-top: 20px;">Ngày sinh</label>
						...
						<label for="" style="margin-top: 20px;">Giới tính</label>
						<div class="input-box">
						...
						<label for="" style="margin-top: 10px;">CPA</label>
						<input name="cpa" type="cpa" class="form-control" id="cpa" placeholder="Điểm trung bình môn" value="{{$user->cpa}}"><br>

						<label for="" style="margin-top: 10px;">TPA</label>
						<input name="tpa" type="tpa" class="form-control" id="tpa" placeholder="Điểm trung bình rèn luyện" value="{{$user->tpa}}"><br>

						<label for="" style="margin-top: 10px;">Mức độ cảnh cáo</label>
						<input name="warning_level" type="warning_level" class="form-control" id="warning_level" placeholder="Mức độ cảnh cáo" value="{{$user->warning_level}}"><br>
	...
	<script type="text/javascript">
		$('.btn-save').click(function(){
			...
			form_data.append("cpa", $('#cpa').val());
			form_data.append("tpa", $('#tpa').val());
			form_data.append("warning_level", $('#warning_level').val());
