...
<section class="content">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Điểm sinh viên</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<table id="list-data" class="table table-bordered table-striped" style="margin-top : 10px;">
						<thead>
							<tr>
								<th class="col-sm-1 text-center">Học kỳ</th>
								<th class="col-sm-1 text-center">Mã lớp</th>
								<th class="col-sm-2 text-center">Tên lớp</th>
								<th class="col-sm-2 text-center">Giảng viên</th>
						...
						<tbody>
							...
							<tr>
								<td class="col-sm-1 text-center">{{$value->creditClass->schoolYears->name}} {{$value->creditClass->schoolYears->session}}</td>
								<td class="col-sm-1 text-center">{{$value->creditClass->code}}</td>
								<td class="col-sm-2 text-center">{{$value->creditClass->name}}</td>
								<td class="col-sm-2 text-center">{{$value->creditClass->lecturers->first_name}} {{$value->creditClass->lecturers->last_name}}</td>
	...
	<!-- modal edit -->
	<div class="col-xs-12">
		<div class="modal fade" id="editPoint" tabindex="-1" role="dialog" aria-labelledby="formFillData" aria-hidden="true">
				...
				<div class="modal-content" style="border-radius : 10px;">
					...
					<form action="" id="formPoint">
						...
						<div class="modal-body">
							...
							<input name="creditClassId" type="text" class="form-control hidden" id="editCreditClassId"><br>
							<input name="attendancePoint" type="text" class="form-control" id="editAttendancePoint" placeholder="Điểm chuyên cần"><br>
							<input name="revisePoint" type="text" class="form-control" id="editRevisePoint" placeholder="Điểm bài tập"><br>
							<input name="practicePoint" type="text" class="form-control" id="editPracticePoint" placeholder="Điểm thực hành"><br>
							<input name="middleTestPoint" type="text" class="form-control" id="editMiddleTestPoint" placeholder="Điểm thi giữa kỳ"><br>
							<input name="finishTestPoint" type="text" class="form-control" id="editFinishTestPoint" placeholder="Điểm thi cuối kỳ"><br>
						</div>
