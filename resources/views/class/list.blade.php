...
<section class="content">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Danh sách lớp chuyên ngành</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					@if(Auth::guard('admin')->check() && Auth::guard('admin')->user()->position == 'Administrators')
					<div style="margin-bottom: 30px;">
						<a href="/admin/new/class" data-toggle="modal" class="btn btn-success btn-add">Thêm mới</a>
					</div>
					@endif
	...
	<!-- modal view -->
	<div class="col-xs-12">
		<div class="modal fade" id="showClass" tabindex="-1" role="dialog" aria-labelledby="formFillData" aria-hidden="true">
				...
				<div class="modal-content" style="border-radius : 10px;">
					...
					<form action="" id="">
						...
						<div class="modal-body">
							<input name="name" type="text" class="form-control" id="showName" placeholder="lớp" disabled><br>
				...
				<div class="modal-content" style="border-radius : 10px;">
					...
					<form action="" id="formEditClass">
						...
						<div class="modal-body">
							...
							<input name="name" type="text" class="form-control" id="editName" placeholder="Tên lớp"><br>
							<input name="description" type="text" class="form-control" id="editDescription" placeholder="Tên lớp"><br>
						</div>
