...
<section class="content">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div style="margin-bottom: 30px;">
						<a href="/admin/new/subject" data-toggle="modal" class="btn btn-success btn-add">Thêm mới</a>
					</div>
					@endif
					<table id="list-data" class="table table-bordered table-striped" style="margin-top : 10px;">
						<thead>
							<tr>
								...
								<th class="col-sm-1 text-center">Mã môn học</th>
								<th class="col-sm-2 text-center">Tên môn học</th>
								<th class="col-sm-2 text-center">Mô tả</th>
								<th class="col-sm-2 text-center">Số tín chỉ</th>
						...
						<tbody>
							...
							<tr>
								<td class="col-sm-1 text-center">{{$key+1}}</td>
								...
								<td class="col-sm-2 text-center">{{$value->number_of_credits}}</td>
	...
	<!-- modal view -->
	<div class="col-xs-12">
		<div class="modal fade" id="showSubject" tabindex="-1" role="dialog" aria-labelledby="formFillData" aria-hidden="true">
				...
				<div class="modal-content" style="border-radius : 10px;">
					...
					<form action="" id="">
						...
						<div class="modal-body">
							<input name="name" type="text" class="form-control" id="showName" placeholder="Môn học" disabled><br>
							<input name="code" type="text" class="form-control" id="showCode" placeholder="Mã môn học" disabled><br>
							<input name="description" type="text" class="form-control" id="showDescription" placeholder="Mô tả" disabled><br>
							<input name="number_of_credits" type="text" class="form-control" id="showNumberOfCredits" placeholder="Sô tín chỉ" disabled><br>
						</div>
	...
	<!-- modal edit -->
	<div class="col-xs-12">
		<div class="modal fade" id="editClass" tabindex="-1" role="dialog" aria-labelledby="formFillData" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content" style="border-radius : 10px;">
					<div class="modal-header">
						<h4 class="modal-title">Cập nhật thông tin</h4>
					</div>
					<form action="" id="formEditClass">
						@csrf
						...
						<div class="modal-body">
							...
							<input name="name" type="text" class="form-control" id="editName" placeholder="Tên môn học"><br>
							<input name="code" type="text" class="form-control" id="editCode" placeholder="Mã môn học"><br>
							<input name="description" type="text" class="form-control" id="editDescription" placeholder="Tên môn học"><br>
							<input name="number_of_credits" type="text" class="form-control" id="editNumberOfCredits" placeholder="Sô tín chỉ"><br>
						</div>
		...
		$('.btn-show').click(function() {
			...
			$.ajax({
				...
				success: function(response) {
					...
					$('#showNumberOfCredits').val(response.number_of_credits)
				}
			});

			$('#showSubject').modal('show');
		});
		...
		$('.btn-edit').click(function() {
			...
			$.ajax({
				...
				success: function(response) {
					...
					$('#editNumberOfCredits').val(response.number_of_credits)
				}
			});
