        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" style="margin-top: 5px;">Tên môn học</label>
                    <input
                        name="name"
                        type="text"
                        class="form-control"
                    ...
                    <label for="" style="margin-top: 5px;">Mã môn học</label>
                    <input
                        name="code"
                        type="text"
                        class="form-control"
                    ...
                    <label for="" style="margin-top: 5px;">Số tín chỉ</label>
                    <input
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <a href="/admin/subject" class="btn btn-danger"
                            >Hủy bỏ</a
                        >
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(".btn-save").click(function () {
        ...
        form_data.append("number_of_credits", $("#getNumberOfCredits").val());
